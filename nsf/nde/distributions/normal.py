...
class StandardNormal(distributions.Distribution):
    ...
    def _log_prob(self, inputs, context):
        ...
        neg_energy = -0.5 * nsf_utils.sum_except_batch(inputs**2, num_batch_dims=1)
    ...
    def _sample(self, num_samples, context):
        if context is None:
            ...
            return nsf_utils.split_leading_dim(samples, [context_size, num_samples])
...
class ConditionalDiagonalNormal(distributions.Distribution):
    ...
    def _log_prob(self, inputs, context):
        ...
        log_prob = -0.5 * nsf_utils.sum_except_batch(norm_inputs**2, num_batch_dims=1)
