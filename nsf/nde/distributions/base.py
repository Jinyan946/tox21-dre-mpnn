...
class Distribution(nn.Module):
    ...
    def sample(self, num_samples, context=None, batch_size=None):
        ...
        """
        if not nsf_utils.is_positive_int(num_samples):
        ...
        if batch_size is None:
            ...
            if not nsf_utils.is_positive_int(batch_size):
    ...
    def sample_and_log_prob(self, num_samples, context=None):
        ...
        if context is not None:
            ...
            samples = nsf_utils.merge_leading_dims(samples, num_dims=2)
        ...
        if context is not None:
            ...
            log_prob = nsf_utils.split_leading_dim(log_prob, shape=[-1, num_samples])
