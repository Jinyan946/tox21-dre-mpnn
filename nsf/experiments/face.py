...
# data
parser.add_argument(
    "--dataset_name", type=str, default="shannon", help="Name of dataset to use."
)
parser.add_argument(
    "--n_data_points",
    type=int,
...
parser.add_argument(
    "--batch_size", type=int, default=1024, help="Size of batch used for training."
)
parser.add_argument(
...
# model
parser.add_argument(
    "--base_transform_type", type=str, default="rq", help="Which base transform to use."
)
parser.add_argument(
    "--hidden_features",
    type=int,
...
parser.add_argument(
    "--num_flow_steps", type=int, default=2, help="Number of steps of flow."
)

# optimization
parser.add_argument(
    "--learning_rate", type=float, default=5e-4, help="Learning rate for Adam."
)
parser.add_argument(
    "--n_total_steps",
    type=int,
...
# reproducibility
parser.add_argument(
    "--seed", type=int, default=1638128, help="Random seed for PyTorch and NumPy."
)
...
train_dataset = data_.load_face_dataset(
    name=args.dataset_name, num_points=args.n_data_points
)
...
# create model
distribution = distributions.TweakedUniform(low=torch.zeros(dim), high=torch.ones(dim))
